...
*/}}
{{- define "debugprobe.selectorLabels" -}}
app.kubernetes.io/name: {{ include "debugprobe.name" . }}
...
*/}}
{{- define "debugprobe.labels" -}}
helm.sh/chart: {{ include "debugprobe.chart" . }}
{{ include "debugprobe.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "debugprobe.tcpdump.cmd.ds" -}}
{{- $filter := "" -}}
{{- if .Values.tcpdump.filterHost -}}
  {{- $filter = printf " host %s" .Values.tcpdump.filterHost -}}
{{- end -}}
